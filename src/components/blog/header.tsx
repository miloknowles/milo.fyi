...
export default function Header({ title, subtitle, publishedAt }) {
  ...
  return (
    <header className="mb-8 flex flex-col">
      ...
      {subtitle && subtitle !== "" && (
        <div className="text-neutral-600 dark:text-neutral-400 text-lg">{subtitle}</div>
      )}
      <span className="text-neutral-600 dark:text-neutral-400 my-2 font-medium">{formattedDate}</span>
