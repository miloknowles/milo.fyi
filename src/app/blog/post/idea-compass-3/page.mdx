...
Today we're looking at the top-left quadrant. If you consume the same kinds of podcasts and blogs that I do, you'll probably recognize the title as a reference to the [apocryphal](https://hbr.org/2011/08/henry-ford-never-said-the-fast) quote attributed to Henry Ford:
...
<Figure
  ...
  caption={
    <span>
      ...
      (in Mbps), by quarter. If it takes about 3-5 MB/sec to stream movies
      reliably, then launching a streaming service around the inflection point
      in ~2010 is great timing\!
    </span>
  }
/>
...
<Figure
  ...
  caption={
    <span>
      ...
      <a href="https://www.youtube.com/watch?v=MnrJzXM7a6o" target="_blank">
        Source
      </a>
      )
    </span>
...
<Figure
  ...
  caption={
    <span>
      (
      <a
        href="https://about.bnef.com/blog/green-steel-demand-is-rising-faster-than-production-can-ramp-up/"
        target="_blank"
      >
...
**Next up: [Loonshots](/blog/post/idea-compass-4)**
