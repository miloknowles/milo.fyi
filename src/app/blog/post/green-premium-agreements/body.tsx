...
import { Text, Heading, Code } from "@radix-ui/themes";
...
<div className="flex flex-col flex-grow gap-4 relative text-lg pb-8">
  ...
  <MathJax.Node formula="V = P_{market} + P_{premium}"/>
  ...
  <Text>
    ...
    or businesses are willing to pay<a className="footnote-ref" href="#fn1" id="fnref1" role="doc-noteref"><sup>1</sup></a> for the environmental and social benefits.
  </Text>
  ...
  <Text>
    ...
    green cement may not be commercially available in that region yet due to supply chain constraints<a className="footnote-ref" href="#fn2" id="fnref2" role="doc-noteref"><sup>2</sup></a>.
  </Text>
  ...
  <Text>
    ...
    energy industry through <ExternalLink href="https://rmi.org/wp-content/uploads/2018/12/rmi-brc-intro-vppa.pdf">virtual power purchase agreements (vPPAs)</ExternalLink>. vPPAs allow a contractual
  ...
  <ExternalLink href="https://rmi.org/wp-content/uploads/2018/12/rmi-brc-intro-vppa.pdf" className="text-center text-xs">Source: The Rocky Mountain Institute</ExternalLink>
  ...
  <ul className="list-disc pl-4">
    <li>
      Green premium agreements could have a more <ExternalLink href="/blog/funding-climate">catalytic climate impact</ExternalLink> than
      purchasing offsets, since they help move critical technologies down the <ExternalLink href="https://www.orbuch.com/learning-curves-reading-list/">learning curve</ExternalLink>
    </li>
    <li>
      GPAs are suitable for ton-for-ton, <ExternalLink href="https://sciencebasedtargets.org/beyond-value-chain-mitigation">beyond value chain mitigation (BVCM)</ExternalLink>. Some companies
      may prefer to make climate contributions to these kinds of quantifiable projects.
    </li>
    <li>
      Currently, the <ExternalLink href="https://ghgprotocol.org/sites/default/files/standards/Corporate-Value-Chain-Accounting-Reporing-Standard_041613_2.pdf">GHG Protocol</ExternalLink> rules
  ...
  <Text>
    ...
    product is displacing an incumbent product with higher emissions<a className="footnote-ref" href="#fn3" id="fnref3" role="doc-noteref"><sup>3</sup></a>. Generally, this is true
